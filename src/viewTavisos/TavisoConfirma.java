...
public class TavisoConfirma extends JDialog {
	...
	public static void main(String[] args) {
		try {
			TavisoConfirma dialog = new TavisoConfirma();
	...
	public TavisoConfirma() {
		...
		{
			texto = new JLabel("");
			texto.setIcon(new ImageIcon(TavisoConfirma.class.getResource("/img/atencao.png")));
		...
		contentPanel.add(btNao);
		{
			...
			label.setIcon(new ImageIcon(TavisoConfirma.class.getResource("/img/bk.jpeg")));

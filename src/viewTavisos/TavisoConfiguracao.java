...
public class TavisoConfiguracao extends JDialog {
	...
	public static void main(String[] args) {
		try {
			TavisoConfiguracao dialog = new TavisoConfiguracao();
	...
	public TavisoConfiguracao() {
		...
		{
			texto = new JLabel("");
			texto.setIcon(new ImageIcon(TavisoConfiguracao.class.getResource("/img/atencao.png")));
		...
		contentPanel.add(btNao);
		{
			...
			label.setIcon(new ImageIcon(TavisoConfiguracao.class.getResource("/img/bk.jpeg")));

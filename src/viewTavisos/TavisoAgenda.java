...
public class TavisoAgenda extends JDialog {
	...
	public static void main(String[] args) {
		try {
			TavisoAgenda dialog = new TavisoAgenda();
	...
	public TavisoAgenda() {
		...
		{
			texto = new JLabel("TEM CERTEZA QUE DESEJA REALIZAR ESTA AÇÃO ?");
			texto.setIcon(new ImageIcon(TavisoAgenda.class.getResource("/img/atencao.png")));
		...
		contentPanel.add(btNao);
		{
			...
			label.setIcon(new ImageIcon(TavisoAgenda.class.getResource("/img/bk.jpeg")));

...
public class T_012_fornecedores extends JPanel {
	...
	public T_012_fornecedores() {
		...
		tabbedPane.addTab("Fonecedores", new ImageIcon(T_012_fornecedores.class.getResource("/img/options.png")), panel, null);
		...
		adcionar.setToolTipText("Adicionar Novo Fornedor");
		...
		deletar.setToolTipText("Remover Fornecedor");

...
public class Tservicos extends JPanel {
	...
	public Tservicos() {
		...
		tabbedPane.addTab("Servi\u00E7os e Ofertas", new ImageIcon(Tservicos.class.getResource("/img/gambler pequeno.png")), panel, null);
